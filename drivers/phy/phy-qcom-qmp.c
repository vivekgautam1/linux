...
static const char *msm8996_phy_clk_l[] = {
	"aux", "cfg_ahb", "ref",
};

static const char *msm8996_pciephy_reset_l[] = {
	"phy", "common", "cfg",
};

static const char *msm8996_usb3phy_reset_l[] = {
	"phy", "common",
};
...
err_com_init:
	for (i = qmp->cfg->num_clks - 1; i >= 0; i--)
		clk_disable_unprepare(qmp->clks[i]);
